...
export class Observability {
    ...
    public getLogger(name: string, tags?: ObservabilityTags): Logger {
        const logger = () => this.loggers.get(name) ?? this.defaultLogger ?? sharedObservabilityConfig().logger ?? Observability.createNullLogger();
    ...
    public getMetrics(name: string, tags?: ObservabilityTags): Metrics {
        const metrics = () => this.metrics.get(name) ?? this.defaultMetrics ?? sharedObservabilityConfig().metrics ?? Observability.createNullMetrics();
